...
const Home = () => {
  return <div className=' bg-primary/60 h-full'>
    {/* text */}
    <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/10 to-black/30'>
         <div className='flex flex-col text-center justify-center xl:pt-40 xl:text-left h-full container mx-auto'>
            ...
            Hi.. am <span className='text-accent'>Phil</span>,  and I welcome you on a journey of innovation to transform your creative concepts into captivating digital experiences, 
            leveraging the latest technologies and forward-thinking solutions.
            </motion.p>
            {/* proctectsBtn */}
